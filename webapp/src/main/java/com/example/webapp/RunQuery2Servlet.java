...
@WebServlet("/runQuery2")
public class RunQuery2Servlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        // Handle GET request
        resp.setContentType("text/html");

        String input2 = req.getParameter("inputText2");
        String loginOption = req.getParameter("loginOption");
        String customLoginOption = req.getParameter("customLoginOption");

        // Determine final selected value (dropdown or custom input)
        String selectedValue = (loginOption != null && loginOption.equals("other")) ? customLoginOption : loginOption;

        List<Map<String, String>> resultList = DatabaseService.fetchClientRequests(input2, selectedValue);
        String returnedData = "";

        String keyToFetch = "REQUEST_ID";
        ...
        resp.getWriter().write(
            ...
            "<p><strong>Executed with input:</strong> " + input2 + "</p>" +
