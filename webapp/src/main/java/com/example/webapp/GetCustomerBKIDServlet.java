...
@WebServlet("/getCustomerBKID")
public class GetCustomerBKIDServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        // Handle GET request
        resp.setContentType("text/html");

        String input3 = req.getParameter("inputText3");
        List<Map<String, String>> resultList = DatabaseServiceGW.GetBKID(input3);
        String returnedData = "";

        String keyToFetch = "ID";
        ...
        resp.getWriter().write(
            ...
            "<p><strong>Executed with input:</strong> " + input3 + "</p>" +
