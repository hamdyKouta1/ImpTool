 ...
 * @author hamdy
 */
@WebServlet("/CustomRquestServlet")

public class CustomRquestServlet extends HttpServlet {
 ...
 String myurl = "http://xx.xxx.xxx.xxx:xxxx/xxx/xxxxxxxxxx";
String rqUID = UUID.randomUUID().toString();
        ...
        String input5 = req.getParameter("inputText5");
        String input6 = req.getParameter("inputText6");
        StringBuilder input6StringBuilder= new StringBuilder(input6);
        String returnedData = ClearCacheFunction.sendSOAPRequest(myurl,input6StringBuilder);
        ...
        resp.getWriter().write(
            ...
            "<p><strong>Executed with input:</strong> " + input5 + "</p>" +
