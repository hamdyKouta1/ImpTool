...
@WebServlet("/ClearBillerCacheServlet")
public class ClearBillerCacheServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String resultList = DatabaseServiceGW.ClearBillerCache();
        ...
        resp.getWriter().write(
            ...
            "<p><strong>Data:</strong> <span id='resultData'>" + resultList + "</span></p>" +
